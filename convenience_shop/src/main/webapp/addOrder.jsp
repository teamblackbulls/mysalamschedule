...
%>
	...
	<nav>
	    <div class="menu">
	      ...
	      <ul>
			...
			<li><a href="ListOrderDetailController">Back</a>
		  </ul>
	    </div>
	</nav>
	...
	<div class="container col-md-5">
		<div class="card">
			...
			<form method="post" action="AddOrderDetailController">
					<caption>
					...
					<button type="submit" class="btn btn-success" formaction="AddOrderDetailController?orderid=<%=orderid%>">Submit</button>
	...
	<%-- LIST ORDER DETAILS BY ORDERID --%>
			...
			<div>
				<table>
					...
					<tr>
						...
						<td><a  href='DeleteOrderDetailController?orderdetailID=<%=result.getInt("orderdetailid")%>&orderID=<%=orderid%>'>Delete</a></td>
					</tr>
					<%
      					}
     				%>
		...
		<button class="btn btn-success" style="padding:10px 10px 10px 10px; text-align:center; margin:3px 100px 100px 950px;" onclick="location.href='UpdateOrderController?grandtotal=<%=grandtotal%>&orderID=<%=orderid%>'">Proceed</button>
