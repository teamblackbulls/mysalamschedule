...
<body>
	    ...
	    <div class="center">
			...
			<div class="button-section">
	             <a href="addOrder.jsp"><button type="button">Add Order</button></a>
			</div>
			...
			<table border="1">
				...
				<tr>
					...
					<td><a class="btn btn-primary" href="UpdateOrderController?orderID=<c:out value="${od.orderID}"/>">Update</a></td>
