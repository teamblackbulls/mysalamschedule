...
@WebServlet("/DeleteOrderDetailCashierController")
public class DeleteOrderDetailCashierController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private OrderDetailDAO dao;
       
    public DeleteOrderDetailCashierController() {
        super();
